...
export default function SunnyIslandLogo(props: ThreeElements['group']) {
  ...
  const [scale, setScale] = useState<number>(window.innerWidth <= 600 ? 0.8 : 1.25);
  ...
  return (
    ...
    <group  rotation={[0, 0, -1.125]} ref={group} {...props} scale={scale} position={[0.5, 0,0.3]} dispose={null}>
