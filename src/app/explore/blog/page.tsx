...
// [Keep all the existing interfaces and types as they are]
interface Article {
  id: number;
  title: string;
  description: string;
...
// [Keep the shuffleArray and fetchImageForKeyword functions as they are]
...
export default async function BlogPage({ searchParams }: BlogPageProps) {
  ...
  // [Keep all the data fetching and processing logic as is]
    ...
    <>
      ...
      <section className="relative min-h-[70vh] overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[70vh] text-center px-4 py-20">
          ...
          >
            {[
              { number: articlesToDisplay.length, label: "Articles" },
