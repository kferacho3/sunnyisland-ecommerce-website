...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description:
      "Crispy fried sweet plantains with a savory twist, perfectly balancing natural sweetness with a spicy drizzle. Smash the plantain for easier dipping",
    imageUrl:
  ...
  {
    id: 60,
    title: "Jeyuk Bokkeum (Korean Pork Bulgogi)",
    description:
  ...
  },
  {
    ...
    description:
      "Breaded and fried thin slices of veal served with lemon wedges—a classic Argentine comfort food.",
  ...
  },
  {
    ...
    instructions: [
      "Heat vegetable oil in a large pot over medium-high heat. Stir in brown sugar and let it caramelize until dark golden brown, about 1–2 minutes.",
      "Add beef and stir to coat with the caramelized sugar, browning the meat on all sides.",
      "Add onion, garlic, and thyme. Cook for 2–3 minutes until fragrant.",
      "Pour in coconut milk and water (or beef broth). Bring to a gentle boil.",
      "Stir in the rice and pigeon peas, then season with salt and black pepper.",
      "Reduce heat to low, cover, and simmer until the rice is tender and the liquid is absorbed, about 25–30 minutes.",
      "Fluff with a fork before serving.",
    ],
  },
  {
    id: 144,
    title: "Trinidad Chicken Palau",
    description:
    ...
    instructions: [
      "Warm vegetable oil in a large pot over medium-high heat, then add brown sugar and let it caramelize until golden brown.",
      "Add chicken pieces, stirring to coat them in the caramelized sugar. Brown the chicken on all sides.",
      "Stir in onion, garlic, and thyme. Cook until onions are softened and fragrant.",
      "Add coconut milk and water (or chicken broth), then bring the mixture to a simmer.",
      "Add the rice and pigeon peas, season with salt and black pepper, and stir well.",
      "Lower the heat to low, cover, and cook until the rice is tender and the liquid is absorbed, about 25–30 minutes.",
  ...
  },
  {
    ...
    description:
      "A flavorful stir-fried noodle dish from Guyana, influenced by Chinese cooking and packed with fresh vegetables and protein.",
    imageUrl: "https://www.epicurious.com/photos/guyanese-chow-mein.jpg",
    link: "https://www.example.com/guyanese-chow-mein",
    country: "Guyana",
    cuisine: "Guyanese",
    ingredients: [
      "8 oz chow mein noodles",
      "1 lb chicken or shrimp, peeled and deveined (optional)",
      "2 tablespoons vegetable oil",
      "1 onion, sliced",
      "2 cloves garlic, minced",
    ...
    instructions: [
      ...
      "If using chicken or shrimp, season lightly with salt and pepper. Heat 1 tablespoon of oil in a wok or large skillet over medium-high heat and stir-fry the protein until cooked. Remove and set aside.",
      "Add the remaining oil to the wok. Stir-fry onion and garlic for 1 minute.",
      "Add carrots, cabbage, and bell pepper. Stir-fry for 2–3 minutes, keeping the vegetables crisp-tender.",
      "Return the cooked chicken or shrimp to the pan. Stir in the cooked chow mein noodles.",
      "Add soy sauce, sesame oil (if using), salt, black pepper, and red pepper flakes if you want some heat.",
      "Toss everything well to combine. Adjust seasoning to taste and serve hot.",
    ],
  },
  {
    id: 146,
    ...
    description:
      "A classic Chinese dish featuring crispy duck skin and tender meat, usually served with thin pancakes, scallions, and hoisin sauce.",
    imageUrl: "https://www.epicurious.com/photos/chinese-peking-duck.jpg",
    link: "https://www.example.com/chinese-peking-duck",
    country: "China",
    cuisine: "Chinese",
    ingredients: [
      "1 whole duck (about 5–6 lbs), cleaned",
      "2 tablespoons honey",
      "2 tablespoons soy sauce",
      "1 tablespoon Chinese five-spice powder",
      "2 cups boiling water",
      "Hoisin sauce for serving",
      "Thin Mandarin pancakes for serving",
      "Scallions (green onions), cut into thin strips, for serving",
      "Cucumber strips (optional)",
    ],
    instructions: [
      "Rinse and pat the duck dry. Prick the skin all over with a sharp knife, being careful not to pierce the meat.",
      "Mix honey, soy sauce, and five-spice powder in a small bowl. Rub this mixture all over the duck skin.",
      "Place the duck on a rack over a roasting pan. Pour 2 cups of boiling water into the pan (not over the duck).",
      "Let the duck air-dry uncovered in the refrigerator for at least 4 hours, or overnight for best results (this helps crisp the skin).",
      "Preheat the oven to 375°F (190°C). Roast the duck breast-side up for about 1 hour, then carefully flip and roast for another 30 minutes or until the skin is crisp and the internal temperature reaches 165°F (74°C).",
      "Rest the duck for 10–15 minutes before carving. Serve slices of duck with hoisin sauce, scallions, cucumber strips, and Mandarin pancakes.",
    ],
  },
  {
    id: 147,
    ...
    description:
      "A staple side dish in Trinidad, featuring creamy pigeon peas simmered in a richly flavored stew with herbs and aromatics.",
    imageUrl:
    ...
    instructions: [
      "Heat vegetable oil in a saucepan over medium-high heat. Add brown sugar and let it caramelize until dark golden brown.",
      "Stir in onion and garlic, cooking until onions are translucent, about 3 minutes.",
      "Add chopped tomato and thyme, and cook for another minute.",
      "Add pigeon peas, then stir in coconut milk and water (or broth).",
      "Season with salt and black pepper. Reduce heat, cover, and simmer for 15–20 minutes, allowing flavors to meld and the peas to soften.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "2 ears fresh corn, cut into segments (or 2 cups frozen corn kernels)",
      "1 onion, chopped",
      "2 cloves garlic, minced",
      "1 carrot, chopped",
    ...
    instructions: [
      "In a large pot, bring split peas and water (or broth) to a boil. Reduce heat and simmer for 20–25 minutes until split peas begin to soften.",
      "Add corn, onion, garlic, carrot, sweet potato, and thyme. Continue to simmer until all the vegetables are tender, about 15–20 minutes.",
      "Season with salt and black pepper. For a thicker consistency, lightly mash some of the vegetables and split peas with a wooden spoon.",
      "Taste and adjust seasoning. Garnish with chopped scallions or cilantro before serving.",
    ],
  },
  {
    id: 149,
    ...
    description:
      "An assortment of sushi rolls and nigiri featuring vinegared rice, fresh seafood, and vegetables, served with soy sauce, wasabi, and pickled ginger.",
    imageUrl: "https://www.epicurious.com/photos/japanese-sushi-platter.jpg",
    ...
    ingredients: [
      ...
      "1 tablespoon sugar",
      "1 teaspoon salt",
      "Assorted fish (e.g., tuna, salmon) or cooked shrimp",
      "Sheets of nori (for rolls)",
      "Vegetables (e.g., cucumber, avocado, carrot), sliced into strips",
      "Soy sauce, wasabi, and pickled ginger for serving",
    ],
    instructions: [
      "Rinse the rice several times until the water runs clear. Combine rice and water in a pot and let it soak for 20 minutes.",
      "Cook the rice on medium heat until it boils, then reduce heat to low, cover, and cook for about 15 minutes. Remove from heat and let it sit, covered, for 10 more minutes.",
      "Meanwhile, warm rice vinegar, sugar, and salt in a small saucepan until the sugar dissolves. Do not boil.",
      "Transfer the hot rice to a large bowl. Gently fold in the vinegar mixture with a spatula, fanning the rice to cool it quickly.",
      "For nigiri, shape small ovals of rice and place a slice of fish or shrimp on top. For rolls, place a sheet of nori on a bamboo mat, spread rice, add fillings, and roll tightly.",
      "Slice rolls into pieces. Serve the sushi assortment with soy sauce, wasabi, and pickled ginger.",
    ],
  },
  {
    id: 150,
    ...
    description:
      "A tangy and sweet dish featuring crispy chicken pieces coated in a bright lemon sauce, a popular choice in many Chinese restaurants.",
    imageUrl: "https://www.epicurious.com/photos/chinese-lemon-chicken.jpg",
    ...
    instructions: [
      "Season chicken pieces with salt and pepper. Dip them into beaten egg, then coat with cornstarch.",
      "Heat oil in a deep skillet or wok over medium-high heat. Fry chicken until golden brown and cooked through, then drain on paper towels.",
      "In a separate saucepan, combine chicken broth, lemon juice, sugar, and soy sauce. Bring to a simmer, adjusting sweetness or tartness to taste.",
      "Stir in the cornstarch slurry and whisk until the sauce thickens, about 1 minute.",
      "Add the fried chicken to the sauce and toss to coat evenly.",
      "Garnish with lemon slices and chopped scallions. Serve hot with steamed rice.",
    ],
  },
];
